      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <input
            ...
            className="w-[72px] rounded border border-border2 bg-raised px-1.5 py-0.5 font-mono text-[10px] text-foreground focus:border-accent-porter focus:outline-none"
          />
        </div>
      </div>
  ...
  return (
    <div className={cn("flex gap-6", className)}>
      ...
      <div className="flex flex-col items-center gap-3">
        ...
        <p className="text-[10px] text-text3">Live preview — all sizes</p>
      </div>
