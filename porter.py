#!/usr/bin/env python3
"""Porter v0.12.8 — self-hosted file manager"""
...
<aside class="sidebar">
  ...
  <div class="sidebar-footer">
    <div style="font-size:10px;color:var(--text3);margin-bottom:12px;letter-spacing:0.5px">PORTER v0.12.8</div>
  </div>
</aside>
...
const CHANGELOG = [
  { ver:'v0.12.8', date:'2026-02-25', notes:[
    'Tailscale Devices group now includes the current VPS/Hostinger device instead of listing it separately',
    'Connectivity summary simplified to unified device count',
    'Device list marks Hostinger as "(this device)" for clarity',
  ]},
...
function renderTailscaleStatus(data) {
  ...
  el.innerHTML = `
    ...
    </div>` : '<div style="font-size:13px;color:var(--text3)">No devices found.</div>'};
  };
...
if __name__ == "__main__":
    ...
    print(f"\n  Porter v0.12.8 ready (localhost only)")
