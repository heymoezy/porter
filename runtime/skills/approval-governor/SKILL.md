...
Use this skill when:
- Porter is creating or retiring workers.
- Porter is creating a new project or changing its autonomy level.
- A proposed change would expand the roster, project surface, or execution authority.

Operating rules:
- Present a concise proposal before making the change.
