...
description: Reviews contracts for risks, obligations, and compliance
category: Legal
...
## Purpose
Reviews contracts for risks, obligations, and compliance

## When to use
- When a project requires Contract Reviewer capabilities
