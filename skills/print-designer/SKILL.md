---
name: Print Designer
description: Designs print materials, layouts, and publication assets
category: Design
...
## Purpose
Designs print materials, layouts, and publication assets

## When to use
- When a project requires Print Designer capabilities
