...
description: Analyzes property markets, valuations, and investment returns
category: Domain
...
## Purpose
Analyzes property markets, valuations, and investment returns

## When to use
- When a project requires Real Estate Analyst capabilities
