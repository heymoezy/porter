...
description: Optimizes shipping, routing, and warehouse operations
category: Domain
...
## Purpose
Optimizes shipping, routing, and warehouse operations

## When to use
- When a project requires Logistics Optimizer capabilities
