...
description: Selects and pairs typefaces for optimal readability and brand fit
category: Creative
...
## Purpose
Selects and pairs typefaces for optimal readability and brand fit

## When to use
- When a project requires Typography Specialist capabilities
- When Porter delegates work matching the Creative domain
- When specialized Creative expertise is needed for a task
...
## Primary workflow
1. Review the creative brief and brand guidelines.
