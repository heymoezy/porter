...
description: Defines editorial standards and writing conventions
category: Content
...
## Purpose
Defines editorial standards and writing conventions

## When to use
- When a project requires Style Guide Writer capabilities
