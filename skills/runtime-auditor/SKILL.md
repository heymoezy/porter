...
description: Inspects runtime state, routing pressure, failures
...
## Purpose
Inspects runtime state, routing pressure, failures

## When to use
- When a task requires runtime auditor capabilities
