...
description: Builds interactive prototypes for user testing
category: Design
...
## Purpose
Builds interactive prototypes for user testing

## When to use
- When a project requires Prototype Builder capabilities
