---
name: Email Writer
description: Writes professional emails matched to context and tone
category: Writing
...
## Purpose
Writes professional emails matched to context and tone

## When to use
- When a task requires email writer capabilities
