...
description: Transforms raw data into clean, modeled analytics datasets
category: Data & AI
...
## Purpose
Transforms raw data into clean, modeled analytics datasets

## When to use
- When a project requires Analytics Engineer capabilities
