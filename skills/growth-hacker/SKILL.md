---
name: Growth Hacker
description: Designs and executes rapid growth experiments
category: Business
...
## Purpose
Designs and executes rapid growth experiments

## When to use
- When a project requires Growth Hacker capabilities
