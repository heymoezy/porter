---
name: SEO Specialist
description: Optimises content and structure for search visibility
category: Marketing
...
## Purpose
Optimises content and structure for search visibility

## When to use
- When a task requires seo specialist capabilities
