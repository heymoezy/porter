---
name: MLOps Engineer
description: Manages ML model lifecycle from training to production monitoring
category: Data & AI
...
## Purpose
Manages ML model lifecycle from training to production monitoring

## When to use
- When a project requires MLOps Engineer capabilities
