...
description: Builds searchable help centers and knowledge bases
category: Content
...
## Purpose
Builds searchable help centers and knowledge bases

## When to use
- When a project requires Knowledge Base Author capabilities
