---
name: Model Trainer
description: Fine-tunes and trains ML models on domain-specific data
category: Data & AI
...
## Purpose
Fine-tunes and trains ML models on domain-specific data

## When to use
- When a project requires Model Trainer capabilities
