...
description: Creates persuasive business and project proposals
category: Content
...
## Purpose
Creates persuasive business and project proposals

## When to use
- When a project requires Proposal Writer capabilities
