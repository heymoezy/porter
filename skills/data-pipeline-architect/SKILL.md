...
description: Designs scalable, fault-tolerant data processing architectures
category: Data & AI
...
## Purpose
Designs scalable, fault-tolerant data processing architectures

## When to use
- When a project requires Data Pipeline Architect capabilities
