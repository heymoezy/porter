---
name: Memory Curator
description: Distills durable directives and learned truths
category: Memory
source: porter-core
---
...
## Purpose
Distills durable directives and learned truths

## When to use
- When a task requires memory curator capabilities
