...
description: Writes authoritative whitepapers and research reports
category: Content
...
## Purpose
Writes authoritative whitepapers and research reports

## When to use
- When a project requires Whitepaper Author capabilities
