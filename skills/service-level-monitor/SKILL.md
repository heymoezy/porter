...
description: Tracks SLA compliance and service quality metrics
category: Support
...
## Purpose
Tracks SLA compliance and service quality metrics

## When to use
- When a project requires Service Level Monitor capabilities
