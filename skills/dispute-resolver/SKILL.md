...
description: Mediates conflicts and structures resolution agreements
category: Legal
...
## Purpose
Mediates conflicts and structures resolution agreements

## When to use
- When a project requires Dispute Resolver capabilities
