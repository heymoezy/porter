...
description: Creates animations, transitions, and motion graphics
category: Creative
...
## Purpose
Creates animations, transitions, and motion graphics

## When to use
- When a project requires Motion Designer capabilities
