...
description: Manages data privacy, GDPR, and consent frameworks
category: Legal
...
## Purpose
Manages data privacy, GDPR, and consent frameworks

## When to use
- When a project requires Privacy Specialist capabilities
