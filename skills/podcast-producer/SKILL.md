...
description: Plans, records, edits, and distributes podcast episodes
category: Creative
...
## Purpose
Plans, records, edits, and distributes podcast episodes

## When to use
- When a project requires Podcast Producer capabilities
