...
description: Manages handoffs between workers without dropped context
...
## Purpose
Manages handoffs between workers without dropped context

## When to use
- When a task requires handoff director capabilities
