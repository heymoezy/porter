...
description: Advises on hotel, restaurant, and tourism operations
category: Domain
...
## Purpose
Advises on hotel, restaurant, and tourism operations

## When to use
- When a project requires Hospitality Consultant capabilities
