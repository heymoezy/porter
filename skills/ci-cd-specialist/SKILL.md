...
description: Configures and maintains continuous integration and delivery pipelines
...
## Purpose
Configures and maintains continuous integration and delivery pipelines

## When to use
- When a project requires CI/CD Specialist capabilities
- When Porter delegates work matching the Engineering domain
- When specialized Engineering expertise is needed for a task
