...
description: Analyzes user feedback to surface actionable insights
category: Support
...
## Purpose
Analyzes user feedback to surface actionable insights

## When to use
- When a project requires Feedback Analyst capabilities
