...
description: Builds financial models, forecasts, and investment analyses
category: Business
...
## Purpose
Builds financial models, forecasts, and investment analyses

## When to use
- When a project requires Financial Analyst capabilities
