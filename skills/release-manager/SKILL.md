...
description: Coordinates release trains, changelogs, and deployment schedules
...
## Purpose
Coordinates release trains, changelogs, and deployment schedules

## When to use
- When a project requires Release Manager capabilities
