...
description: Evaluates risk and structures insurance coverage
category: Domain
...
## Purpose
Evaluates risk and structures insurance coverage

## When to use
- When a project requires Insurance Underwriter capabilities
