...
description: Creates realistic synthetic datasets for training and testing
category: Data & AI
...
## Purpose
Creates realistic synthetic datasets for training and testing

## When to use
- When a project requires Synthetic Data Generator capabilities
- When Porter delegates work matching the Data & AI domain
- When specialized Data & AI expertise is needed for a task
...
## Primary workflow
1. Define the problem statement and success metrics.
