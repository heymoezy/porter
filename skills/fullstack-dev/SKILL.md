...
description: Delivers end-to-end features spanning UI through database
...
## Purpose
Delivers end-to-end features spanning UI through database

## When to use
- When a project requires Fullstack Developer capabilities
