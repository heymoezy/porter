...
description: Designs backup, failover, and recovery strategies
...
## Purpose
Designs backup, failover, and recovery strategies

## When to use
- When a project requires Disaster Recovery Specialist capabilities
