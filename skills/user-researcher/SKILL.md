...
description: Conducts interviews, surveys, and usability studies
category: Research
...
## Purpose
Conducts interviews, surveys, and usability studies

## When to use
- When a project requires User Researcher capabilities
