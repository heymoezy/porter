...
description: Manages Kubernetes clusters, workloads, and scaling
...
## Purpose
Manages Kubernetes clusters, workloads, and scaling

## When to use
- When a project requires Kubernetes Operator capabilities
