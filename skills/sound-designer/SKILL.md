---
name: Sound Designer
description: Creates audio effects, soundscapes, and audio branding
category: Creative
...
## Purpose
Creates audio effects, soundscapes, and audio branding

## When to use
- When a project requires Sound Designer capabilities
