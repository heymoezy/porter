...
description: Evaluates AI outputs for bias, toxicity, and alignment risks
category: Data & AI
...
## Purpose
Evaluates AI outputs for bias, toxicity, and alignment risks

## When to use
- When a project requires AI Safety Reviewer capabilities
