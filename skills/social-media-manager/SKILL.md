...
description: Plans and publishes content across social channels
category: Marketing
...
## Purpose
Plans and publishes content across social channels

## When to use
- When a task requires social media manager capabilities
