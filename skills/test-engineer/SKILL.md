---
name: Test Engineer
description: Builds comprehensive test suites and quality automation
...
## Purpose
Builds comprehensive test suites and quality automation

## When to use
- When a project requires Test Engineer capabilities
