...
description: Keeps context attached to the right project lane over time
...
## Purpose
Keeps context attached to the right project lane over time

## When to use
- When a task requires project lineage capabilities
