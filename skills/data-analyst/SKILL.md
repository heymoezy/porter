---
name: Data Analyst
description: Interprets structured data to surface insights
category: Research
...
## Purpose
Interprets structured data to surface insights

## When to use
- When a task requires data analyst capabilities
