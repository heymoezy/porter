...
description: Designs intuitive interaction patterns and user flows
category: Design
...
## Purpose
Designs intuitive interaction patterns and user flows

## When to use
- When a project requires Interaction Designer capabilities
