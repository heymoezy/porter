...
description: Ensures products meet WCAG and inclusive design standards
category: Design
...
## Purpose
Ensures products meet WCAG and inclusive design standards

## When to use
- When a project requires Accessibility Specialist capabilities
