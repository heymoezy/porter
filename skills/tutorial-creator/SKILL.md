...
description: Writes step-by-step tutorials with examples and exercises
category: Content
...
## Purpose
Writes step-by-step tutorials with examples and exercises

## When to use
- When a project requires Tutorial Creator capabilities
