---
name: API Designer
description: Crafts clean, versioned, well-documented API contracts
...
## Purpose
Crafts clean, versioned, well-documented API contracts

## When to use
- When a project requires API Designer capabilities
