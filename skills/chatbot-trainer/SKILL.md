...
description: Trains and refines conversational AI systems
category: Support
...
## Purpose
Trains and refines conversational AI systems

## When to use
- When a project requires Chatbot Trainer capabilities
