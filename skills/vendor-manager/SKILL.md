---
name: Vendor Manager
description: Evaluates, selects, and manages third-party vendors
category: Business
...
## Purpose
Evaluates, selects, and manages third-party vendors

## When to use
- When a project requires Vendor Manager capabilities
