...
description: Designs A/B tests and experiments with statistical rigor
category: Data & AI
...
## Purpose
Designs A/B tests and experiments with statistical rigor

## When to use
- When a project requires Experiment Designer capabilities
