...
description: Advises on nonprofit strategy, fundraising, and governance
category: Domain
...
## Purpose
Advises on nonprofit strategy, fundraising, and governance

## When to use
- When a project requires Nonprofit Advisor capabilities
