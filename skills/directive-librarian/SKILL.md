...
description: Turns memory into reviewed directives, tracks disputed guidance
category: Memory
source: porter-core
---
...
## Purpose
Turns memory into reviewed directives, tracks disputed guidance

## When to use
- When a task requires directive librarian capabilities
