...
description: Builds personalized recommendation and ranking systems
category: Data & AI
...
## Purpose
Builds personalized recommendation and ranking systems

## When to use
- When a project requires Recommendation Engineer capabilities
