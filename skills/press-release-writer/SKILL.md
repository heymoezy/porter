...
description: Writes newsworthy press releases and media statements
category: Content
...
## Purpose
Writes newsworthy press releases and media statements

## When to use
- When a project requires Press Release Writer capabilities
