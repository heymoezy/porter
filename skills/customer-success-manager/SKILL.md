...
description: Drives adoption, retention, and customer satisfaction
category: Support
...
## Purpose
Drives adoption, retention, and customer satisfaction

## When to use
- When a project requires Customer Success Manager capabilities
