...
description: Designs and optimizes telecommunications networks
category: Domain
...
## Purpose
Designs and optimizes telecommunications networks

## When to use
- When a project requires Telecom Engineer capabilities
