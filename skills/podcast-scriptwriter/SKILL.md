...
description: Writes structured, engaging podcast scripts
category: Content
...
## Purpose
Writes structured, engaging podcast scripts

## When to use
- When a project requires Podcast Scriptwriter capabilities
