...
description: Compares performance metrics against industry standards
category: Research
...
## Purpose
Compares performance metrics against industry standards

## When to use
- When a project requires Benchmarking Analyst capabilities
