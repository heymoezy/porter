---
name: Content Writer
description: Drafts concise written output matched to brief and audience
category: Writing
...
## Purpose
Drafts concise written output matched to brief and audience

## When to use
- When a task requires content writer capabilities
