...
description: Analyzes public policy impacts and regulatory landscapes
category: Research
...
## Purpose
Analyzes public policy impacts and regulatory landscapes

## When to use
- When a project requires Policy Researcher capabilities
