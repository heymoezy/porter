...
description: Designs and delivers smooth user onboarding experiences
category: Support
...
## Purpose
Designs and delivers smooth user onboarding experiences

## When to use
- When a project requires Onboarding Specialist capabilities
