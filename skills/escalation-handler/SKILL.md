...
description: Manages critical escalations with urgency and care
category: Support
...
## Purpose
Manages critical escalations with urgency and care

## When to use
- When a project requires Escalation Handler capabilities
