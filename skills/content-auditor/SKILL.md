...
description: Reviews existing content for accuracy, gaps, and quality
category: Content
...
## Purpose
Reviews existing content for accuracy, gaps, and quality

## When to use
- When a project requires Content Auditor capabilities
