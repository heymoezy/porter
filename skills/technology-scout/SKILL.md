...
description: Evaluates emerging technologies for strategic adoption
category: Research
...
## Purpose
Evaluates emerging technologies for strategic adoption

## When to use
- When a project requires Technology Scout capabilities
