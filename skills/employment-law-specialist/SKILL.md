...
description: Advises on employment law, contracts, and HR compliance
category: Legal
...
## Purpose
Advises on employment law, contracts, and HR compliance

## When to use
- When a project requires Employment Law Specialist capabilities
- When Porter delegates work matching the Legal domain
- When specialized Legal expertise is needed for a task
...
## Primary workflow
1. Identify the legal question and applicable jurisdiction.
