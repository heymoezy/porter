...
description: Builds responsive, accessible web interfaces with modern frameworks
...
## Purpose
Builds responsive, accessible web interfaces with modern frameworks

## When to use
- When a project requires Frontend Developer capabilities
