...
description: Designs and implements server-side logic, APIs, and data layers
...
## Purpose
Designs and implements server-side logic, APIs, and data layers

## When to use
- When a project requires Backend Developer capabilities
