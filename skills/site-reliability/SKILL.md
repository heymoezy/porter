...
description: Ensures uptime, observability, and incident response readiness
...
## Purpose
Ensures uptime, observability, and incident response readiness

## When to use
- When a project requires Site Reliability Engineer capabilities
