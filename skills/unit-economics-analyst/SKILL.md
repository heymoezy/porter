...
description: Analyzes per-unit costs, margins, and profitability drivers
category: Business
...
## Purpose
Analyzes per-unit costs, margins, and profitability drivers

## When to use
- When a project requires Unit Economics Analyst capabilities
- When Porter delegates work matching the Business domain
- When specialized Business expertise is needed for a task
...
## Primary workflow
1. Frame the business question and scope the analysis.
