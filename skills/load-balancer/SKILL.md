...
description: Configures traffic distribution and high availability
...
## Purpose
Configures traffic distribution and high availability

## When to use
- When a project requires Load Balancer Specialist capabilities
