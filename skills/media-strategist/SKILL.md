...
description: Plans multi-channel media campaigns and placements
category: Domain
...
## Purpose
Plans multi-channel media campaigns and placements

## When to use
- When a project requires Media Strategist capabilities
