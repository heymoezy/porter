---
name: CDN Optimizer
description: Optimizes content delivery and edge caching strategies
...
## Purpose
Optimizes content delivery and edge caching strategies

## When to use
- When a project requires CDN Optimizer capabilities
