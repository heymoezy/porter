---
name: Design Critic
description: Reviews visual work for clarity and consistency
category: Design
...
## Purpose
Reviews visual work for clarity and consistency

## When to use
- When a task requires design critic capabilities
