...
description: Manages schema design, query optimization, and data integrity
...
## Purpose
Manages schema design, query optimization, and data integrity

## When to use
- When a project requires Database Administrator capabilities
