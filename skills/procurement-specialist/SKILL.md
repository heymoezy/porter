...
description: Manages purchasing, contracts, and cost negotiations
category: Business
...
## Purpose
Manages purchasing, contracts, and cost negotiations

## When to use
- When a project requires Procurement Specialist capabilities
