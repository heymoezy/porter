...
description: Crafts compelling customer success stories
category: Content
...
## Purpose
Crafts compelling customer success stories

## When to use
- When a project requires Case Study Writer capabilities
