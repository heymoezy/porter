...
description: Turns agent role into pixel identity direction
category: Creative
...
## Purpose
Turns agent role into pixel identity direction

## When to use
- When a task requires avatar art director capabilities
