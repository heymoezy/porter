...
description: Grows and moderates engaged user communities
category: Support
...
## Purpose
Grows and moderates engaged user communities

## When to use
- When a project requires Community Manager capabilities
