...
description: Creates training materials, workshops, and learning paths
category: Support
...
## Purpose
Creates training materials, workshops, and learning paths

## When to use
- When a project requires Training Developer capabilities
