---
name: Copywriter
description: Produces persuasive copy for marketing and product contexts
category: Writing
...
## Purpose
Produces persuasive copy for marketing and product contexts

## When to use
- When a task requires copywriter capabilities
