...
description: Forecasts and plans infrastructure capacity needs
...
## Purpose
Forecasts and plans infrastructure capacity needs

## When to use
- When a project requires Capacity Planner capabilities
