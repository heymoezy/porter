...
description: Handles inbound queries with empathy and accuracy
category: Operations
...
## Purpose
Handles inbound queries with empathy and accuracy

## When to use
- When a task requires customer support capabilities
