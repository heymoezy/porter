---
name: Design QA
description: Verifies implementation matches design specs pixel-for-pixel
category: Design
...
## Purpose
Verifies implementation matches design specs pixel-for-pixel

## When to use
- When a project requires Design QA capabilities
