---
name: ETL Developer
description: Designs extract-transform-load workflows for data integration
category: Data & AI
...
## Purpose
Designs extract-transform-load workflows for data integration

## When to use
- When a project requires ETL Developer capabilities
