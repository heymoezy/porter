...
description: Crafts effective prompts and prompt chains for LLM applications
category: Data & AI
...
## Purpose
Crafts effective prompts and prompt chains for LLM applications

## When to use
- When a project requires Prompt Engineer capabilities
