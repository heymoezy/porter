...
description: Optimizes logistics, inventory, and supplier networks
category: Business
...
## Purpose
Optimizes logistics, inventory, and supplier networks

## When to use
- When a project requires Supply Chain Optimizer capabilities
