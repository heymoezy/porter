---
name: Coding Agent
description: Delegated implementation lane for real code execution
...
## Purpose
Delegated implementation lane for real code execution

## When to use
- When a task requires coding agent capabilities
