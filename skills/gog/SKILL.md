---
name: GoG
description: Fast retrieval and structured lookup for docs and assets
category: Research
source: runtime
---
...
## Purpose
Fast retrieval and structured lookup for docs and assets

## When to use
- When a task requires gog capabilities
