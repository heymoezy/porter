...
description: Produces clear technical documentation, READMEs, and API docs
...
## Purpose
Produces clear technical documentation, READMEs, and API docs

## When to use
- When a project requires Documentation Writer capabilities
