...
description: Conducts due diligence and deal structuring analysis
category: Business
...
## Purpose
Conducts due diligence and deal structuring analysis

## When to use
- When a project requires Mergers & Acquisitions Analyst capabilities
