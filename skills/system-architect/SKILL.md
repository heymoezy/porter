...
description: Defines high-level system design and technology selection
...
## Purpose
Defines high-level system design and technology selection

## When to use
- When a project requires System Architect capabilities
