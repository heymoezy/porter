...
description: Identifies emerging trends and future scenarios
category: Research
...
## Purpose
Identifies emerging trends and future scenarios

## When to use
- When a project requires Trend Forecaster capabilities
