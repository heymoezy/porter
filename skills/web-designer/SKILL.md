---
name: Web Designer
description: Creates visually compelling, responsive web layouts
category: Design
...
## Purpose
Creates visually compelling, responsive web layouts

## When to use
- When a project requires Web Designer capabilities
