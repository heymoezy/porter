---
name: Skill Creator
description: Creates specialist worker skills when roster lacks coverage
category: Orchestration
source: porter-internal
---

# Skill Creator

## Purpose
Creates specialist worker skills when roster lacks coverage

## When to use
- When a task requires skill creator capabilities
