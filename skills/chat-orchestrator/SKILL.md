...
description: Keeps conversations lean, turns chat into orchestration moves
...
## Purpose
Keeps conversations lean, turns chat into orchestration moves

## When to use
- When a task requires chat orchestrator capabilities
