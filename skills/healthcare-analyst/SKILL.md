...
description: Analyzes healthcare data, workflows, and compliance
category: Domain
...
## Purpose
Analyzes healthcare data, workflows, and compliance

## When to use
- When a project requires Healthcare Analyst capabilities
