...
description: Transforms data into visual, shareable infographics
category: Design
...
## Purpose
Transforms data into visual, shareable infographics

## When to use
- When a project requires Infographic Designer capabilities
