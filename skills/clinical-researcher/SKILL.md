...
description: Designs and analyzes clinical studies and health data
category: Research
...
## Purpose
Designs and analyzes clinical studies and health data

## When to use
- When a project requires Clinical Researcher capabilities
