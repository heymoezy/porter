...
description: Applies approval gates before roster/structure changes
...
## Purpose
Applies approval gates before roster/structure changes

## When to use
- When a task requires approval governor capabilities
