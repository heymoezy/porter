...
description: Identifies, prioritizes, and systematically reduces technical debt
...
## Purpose
Identifies, prioritizes, and systematically reduces technical debt

## When to use
- When a project requires Tech Debt Manager capabilities
