...
description: Implements observability, alerting, and logging systems
...
## Purpose
Implements observability, alerting, and logging systems

## When to use
- When a project requires Monitoring Specialist capabilities
