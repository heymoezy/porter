...
description: Profiles and eliminates bottlenecks across the stack
...
## Purpose
Profiles and eliminates bottlenecks across the stack

## When to use
- When a project requires Performance Optimizer capabilities
