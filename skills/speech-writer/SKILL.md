---
name: Speech Writer
description: Crafts persuasive speeches and presentation scripts
category: Content
...
## Purpose
Crafts persuasive speeches and presentation scripts

## When to use
- When a project requires Speech Writer capabilities
