...
description: Benchmarks and validates ML model performance and fairness
category: Data & AI
...
## Purpose
Benchmarks and validates ML model performance and fairness

## When to use
- When a project requires Model Evaluator capabilities
