...
description: Keeps worker aligned to assigned tasks and timing
category: Operations
...
## Purpose
Keeps worker aligned to assigned tasks and timing

## When to use
- When a task requires project operator capabilities
