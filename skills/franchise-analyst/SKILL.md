...
description: Evaluates franchise models and expansion opportunities
category: Business
...
## Purpose
Evaluates franchise models and expansion opportunities

## When to use
- When a project requires Franchise Analyst capabilities
