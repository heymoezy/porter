...
description: Decomposes monoliths into well-bounded, communicating services
...
## Purpose
Decomposes monoliths into well-bounded, communicating services

## When to use
- When a project requires Microservices Designer capabilities
