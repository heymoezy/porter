...
description: Prioritizes features, defines roadmaps, and ships products
category: Business
...
## Purpose
Prioritizes features, defines roadmaps, and ships products

## When to use
- When a project requires Product Manager capabilities
