---
name: Risk Assessor
description: Identifies, quantifies, and mitigates business risks
category: Business
...
## Purpose
Identifies, quantifies, and mitigates business risks

## When to use
- When a project requires Risk Assessor capabilities
