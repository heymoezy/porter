    ...
    <div className="space-y-3">
      ...
      <div className="rounded-xl border border-border overflow-hidden">
        <div className="flex items-center gap-2 px-3 py-2 bg-surface border-b border-border">
          ...
          <span className="text-[11px] font-semibold uppercase tracking-wide text-text3">Server Tools ({serverTools.length})</span>
        </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-border/50 text-left">
                <th className="px-3 py-1.5 text-[11px] font-semibold uppercase tracking-wide text-text3">Tool</th>
                <th className="px-3 py-1.5 text-[11px] font-semibold uppercase tracking-wide text-text3">Version</th>
                <th className="px-3 py-1.5 text-[11px] font-semibold uppercase tracking-wide text-text3">Status</th>
                <th className="px-3 py-1.5 text-[11px] font-semibold uppercase tracking-wide text-text3 text-right">Visible</th>
              </tr>
            </thead>
            <tbody>
              {serverTools.map(t => {
                ...
                return (
                  <tr key={t.key} className="border-b border-border/30 last:border-0">
                    ...
                    <td className="px-3 py-1.5">
                      <Badge className={`text-[10px] border-0 ${t.detected ? "bg-success/15 text-success" : "bg-text3/15 text-text3"}`}>
      ...
      {runtimeTools.length > 0 && (
        <div className="rounded-xl border border-border overflow-hidden">
          <div className="flex items-center gap-2 px-3 py-2 bg-surface border-b border-border">
            ...
            <span className="text-[11px] font-semibold uppercase tracking-wide text-text3">Runtime Tools ({runtimeTools.length})</span>
            <span className="text-[10px] text-text3 ml-1">user-side</span>
          </div>
          <table className="w-full">
            <tbody>
              {runtimeTools.map(t => (
      ...
      <div className="rounded-xl border border-border overflow-hidden">
        <div className="flex items-center gap-2 px-3 py-2 bg-surface border-b border-border">
          ...
          <span className="text-[11px] font-semibold uppercase tracking-wide text-text3">Connections ({connections.length})</span>
        </div>
        {connections.length === 0 ? (
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-border/50 text-left">
                <th className="px-3 py-1.5 text-[11px] font-semibold uppercase tracking-wide text-text3">Provider</th>
                <th className="px-3 py-1.5 text-[11px] font-semibold uppercase tracking-wide text-text3">Kind</th>
                <th className="px-3 py-1.5 text-[11px] font-semibold uppercase tracking-wide text-text3">Tools</th>
                <th className="px-3 py-1.5 text-[11px] font-semibold uppercase tracking-wide text-text3">Status</th>
              </tr>
            </thead>
            <tbody>
              {connections.map(c => (
                <tr key={c.id} className="border-b border-border/30 last:border-0">
                  ...
                  <td className="px-3 py-1.5">
                    <Badge className={`text-[10px] border-0 ${c.status === "connected" ? "bg-success/15 text-success" : "bg-text3/15 text-text3"}`}>
                      {c.status}
                    </Badge>
                  </td>
                </tr>
