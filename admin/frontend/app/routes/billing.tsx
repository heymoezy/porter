  ...
  return (
    <div className="space-y-3">
      ...
      <div className="rounded-xl border border-border bg-surface p-3">
        <span className="text-[11px] font-semibold uppercase tracking-wide text-text3">Customer Funnel</span>
        <div className="flex items-center gap-2 mt-2">
          {[
            ...
            <div key={i} className="flex-1 rounded-lg bg-background p-2 text-center">
              ...
              <p className="text-[10px] text-text3">{step.label}</p>
        ...
        <p className="text-[10px] text-text3 mt-1.5">{r.markup}x markup on all costs</p>
      </div>
      ...
      {r.tokenUsage.length > 0 && (
        <div className="rounded-xl border border-border overflow-hidden">
          <div className="px-3 py-2 bg-surface border-b border-border">
            <span className="text-[11px] font-semibold uppercase tracking-wide text-text3">Token Cost Breakdown</span>
          </div>
          <table className="w-full">
            <thead>
              <tr className="border-b border-border/50 text-left">
                ...
                <th className="px-3 py-1.5 text-[11px] font-semibold uppercase tracking-wide text-text3 text-right">Requests</th>
              </tr>
            </thead>
            <tbody>
              {r.tokenUsage.map(t => (
      ...
      <div className="rounded-xl border border-border overflow-hidden">
        <div className="px-3 py-2 bg-surface border-b border-border">
          <span className="text-[11px] font-semibold uppercase tracking-wide text-text3">Subscriptions</span>
        </div>
