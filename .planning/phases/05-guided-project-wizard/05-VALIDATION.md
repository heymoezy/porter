...
| 05-01-02 | 01 | 1 | PROJ-01 | integration | `python3 /tmp/test_proj01_detect.py` | ❌ W0 | ⬜ pending |
| 05-02-01 | 02 | 1 | PROJ-02 | integration | `python3 /tmp/test_proj02_agent_match.py` | ❌ W0 | ⬜ pending |
| 05-03-01 | 03 | 2 | PROJ-01 | integration | `python3 /tmp/test_proj01_approve.py` | ❌ W0 | ⬜ pending |
| 05-03-02 | 03 | 2 | PROJ-03 | integration | `python3 /tmp/test_proj03_activity.py` | ❌ W0 | ⬜ pending |
| 05-04-01 | 04 | 3 | PROJ-03 | ui | Playwright: `page.goto('/projects/:id')` | ❌ W0 | ⬜ pending |
| 05-06-01 | 06 | 3 | PROJ-04 | ui | Playwright: toggle GSD mode, verify persistence | ❌ W0 | ⬜ pending |
| 05-06-02 | 06 | 3 | PROJ-04 | integration | `python3 /tmp/test_proj04_gsd_mode.py` | ❌ W0 | ⬜ pending |
...
*Playwright regression suite (35 tests) covers existing surfaces — no new Playwright tests required for Phase 5 new views.*
