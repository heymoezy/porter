...
- [ ] Agent autonomy (scheduled + event-driven work, Porter controls model/tools/skills)
- [ ] Persistent and temporary agents (permanent agents + project-scoped ephemeral agents)
